...
ALTER TABLE movie_scripts COMMENT = '影片剧本表';
ALTER TABLE movie_scripts
    MODIFY COLUMN id CHAR(36) NOT NULL DEFAULT (UUID()) COMMENT '剧本ID',
    MODIFY COLUMN movie_id CHAR(36) NOT NULL COMMENT '关联电影ID',
    MODIFY COLUMN script_title TEXT NULL COMMENT '剧本标题',
    MODIFY COLUMN plot_text LONGTEXT NULL COMMENT '剧情文本',
    MODIFY COLUMN screenplay_text LONGTEXT NOT NULL COMMENT '剧本文本',
    MODIFY COLUMN created_by TEXT NULL COMMENT '上传人',
    MODIFY COLUMN created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    MODIFY COLUMN updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间';

ALTER TABLE movie_dialogue_files COMMENT = '影片对白文件表';
ALTER TABLE movie_dialogue_files
    MODIFY COLUMN id CHAR(36) NOT NULL DEFAULT (UUID()) COMMENT '对白文件ID',
    MODIFY COLUMN movie_id CHAR(36) NOT NULL COMMENT '关联电影ID',
    MODIFY COLUMN file_name TEXT NULL COMMENT '文件名',
    MODIFY COLUMN dialogue_text LONGTEXT NOT NULL COMMENT '对白全文文本',
    MODIFY COLUMN total_lines INT NULL COMMENT '对白行数',
    MODIFY COLUMN created_by TEXT NULL COMMENT '上传人',
    MODIFY COLUMN created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    MODIFY COLUMN updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间';
