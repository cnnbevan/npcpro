...
DELETE FROM movie_dialogue_files;
DELETE FROM movie_scripts;
...
INSERT INTO characters (
  ...
  (
    ...
    '22222222-2222-4222-8222-222222222222',
    '陈永仁',
    JSON_ARRAY('Lau Kin Ming'),
    '梁朝伟',
    '警方卧底，长期深陷黑帮与警队身份冲突。',
    JSON_OBJECT('性格', '沉稳', '特质', '双面人生'),
    TRUE,
    'seed-script'
  ),
  (
